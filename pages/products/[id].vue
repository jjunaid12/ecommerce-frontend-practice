  ...
  <section class="text-gray-600 body-font overflow-hidden">
    <div class="container px-5 py-10 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        <img class="lg:w-1/3 w-full lg:h-auto object-contain h-64 object-center rounded" :src="product!.img">
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-col justify-between">
          ...
          <div class="flex">
            ...
            <button class="flex ml-auto border-black bg-black mt-4 block rounded-md border px-5 py-3 text-sm font-medium text-white hover:bg-gray-700 cursor-pointer">Buy</button>
          </div>
        </div>
      </div>
    </div>
